...
import VotesCalculationAndNotify.Votes;
import com.e_voting_project.Candidate;
import java.awt.*;
import java.awt.event.*;
import javax.swing.*;

public class DisplayVoterScreen {
   ...
   JFrame frame;
	...
	public void displayVoterScreen(String admin_first_name, String admin_last_name) {
...
//        image_right1 = new ImageIcon("C:\\Users\\Khalil\\Documents\\NetBeansProjects\\Electronic_Voting_Project\\src\\images\\stats_icon.png");
        ...
        voteButton.setBounds(450, 200, 150, 40);
        voteButton.setBackground(Color.WHITE);
        voteButton.addActionListener(new ActionListener(){
            @Override
            public void actionPerformed(ActionEvent e) {
                
                 new Votes().voteScreen();
        ...
        text_label.setBounds(50, 250, 300, 50);
