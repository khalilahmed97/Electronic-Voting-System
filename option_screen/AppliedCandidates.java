...
public class AppliedCandidates extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        main_label.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        main_label.setForeground(new java.awt.Color(255, 255, 255));
        main_label.setText("            CANDIDATES");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AppliedCandidates.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
